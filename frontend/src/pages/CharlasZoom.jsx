...
const CharlasZoom = () => {
  ...
  const [selectedFilter, setSelectedFilter] = useState('all'); // 'all' | 'news' | 'zooms'
  ...
  if (loading) {
    return (
      <div style={{ textAlign: 'center', padding: '100px 20px', color: 'var(--gray-400)', fontFamily: 'var(--font-sans)' }}>
        Cargando muro de noticias y charlas Zoom...
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '16px', color: 'var(--gray-400)', maxWidth: '700px', margin: 0, lineHeight: '1.6' }}>
            Mantente informado con los comunicados oficiales en el muro de noticias de la academia, y explora el calendario para unirte a las próximas reuniones Zoom y masterclasses en vivo.
          </p>
        </div>
      ...
      {/* SECCIÓN DE FILTROS (NOTICIAS VS CHARLAS ZOOM) */}
      <div style={{ display: 'flex', gap: '12px', marginBottom: '32px', flexWrap: 'wrap', alignItems: 'center', backgroundColor: '#f1f5f9', padding: '8px', borderRadius: '16px', border: '1px solid #e2e8f0' }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '12px',
            border: 'none',
            backgroundColor: selectedFilter === 'news' ? '#1f75f5ff' : 'transparent',
            color: selectedFilter === 'news' ? '#ffffff' : '#334155',
            fontWeight: '800',
            fontSize: '14px',
            cursor: 'pointer',
        ...
        >
          <IoNewspaperOutline size={18} /> Noticias & Anuncios ({newsEvents.length})
        </button>
        <button
          onClick={() => setSelectedFilter('zooms')}
          style={{
            padding: '10px 20px',
            borderRadius: '12px',
            border: 'none',
            backgroundColor: selectedFilter === 'zooms' ? '#1f75f5ff' : 'transparent',
            color: selectedFilter === 'zooms' ? '#ffffff' : '#334155',
            fontWeight: '800',
            fontSize: '14px',
            cursor: 'pointer',
            transition: 'all 0.2s ease',
        ...
        >
          <IoVideocamOutline size={18} />Charlas Zoom ({events.filter(ev => ev.type !== 'news').length})
        </button>
      </div>

      {/* NEWS WALL / ANUNCIOS DESTACADOS */}
      {(selectedFilter === 'all' || selectedFilter === 'news') && newsEvents.length > 0 && (
        <div style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: '900', color: '#0f172a', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            <IoNewspaperOutline size={26} color="var(--primary)" /> Muro de Noticias & Anuncios Destacados
          </h2>
      ...
      {(selectedFilter === 'all' || selectedFilter === 'zooms') && (
        <>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', backgroundColor: '#f1f5f9', padding: '6px', borderRadius: '14px', border: '1px solid #e2e8f0' }}>
              ...
              >
                <IoListOutline size={16} /> Lista de Charlas
              </button>
            </div>
          </div>
